...
public class MyTripsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.logout:
                ...
                startActivity(new Intent(MyTripsActivity.this,MainActivity.class));
                finish();
                return true;

            case R.id.dashboard:
                Intent intent = new Intent(MyTripsActivity.this,NewProfileActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.mytrip_recycler_view);
        firebaseUser = auth.getCurrentUser();
        assert firebaseUser != null;
        userid = firebaseUser.getUid();
        userIDTrip= firebaseUser.getUid();
        ...
        tripRef.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (!queryDocumentSnapshots.isEmpty()) {
                    ...
                    mlayoutManager = new LinearLayoutManager(MyTripsActivity.this);
                    recyclerView.setLayoutManager(mlayoutManager);
                    mAdapter = new TripAdapter(tripArrayList,userIDTrip);
                    recyclerView.setAdapter(mAdapter);
                    // ViewCompat.setNestedScrollingEnabled(recyclerView,false);
                }
                else{
                    Toast.makeText(MyTripsActivity.this, "You have not joined any trip!", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
